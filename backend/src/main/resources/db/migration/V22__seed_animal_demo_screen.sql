-- V22: seed animal demo screen dataset and preset screen assets
...
'{"chart":{"name":"生态位占比","chartType":"doughnut","xField":"生态位","yField":"数值","groupField":""},"style":{"theme":"深海荧光","bgColor":"rgba(0,0,0,0)","showLegend":true,"showLabel":true,"legendPos":"bottom"},"interaction":{"dataFilters":[{"field":"模块","value":"生态位占比"}]}}'
FROM bi_dashboard d
...
'{"chart":{"name":"感知能力排行","chartType":"table_rank","xField":"能力","yField":"得分","groupField":""},"style":{"showTitle":true,"titleText":"感知能力排行","titleColor":"#eef8ff","metricValueColor":"#67dbff","bgColor":"rgba(7,23,42,0.08)","cardRadius":16},"interaction":{"dataFilters":[{"field":"模块","value":"感知排行"}]}}'
FROM bi_dashboard d
...
'{"chart":{"name":"雪山狼犬节律","chartType":"business_trend","xField":"时段","yField":"活跃指数","groupField":""},"style":{"showTitle":true,"titleText":"雪山狼犬节律","titleColor":"#eef8ff","metricValueColor":"#67dbff","bgColor":"rgba(0,0,0,0)"},"interaction":{"dataFilters":[{"field":"模块","value":"活动趋势"},{"field":"动物","value":"雪山狼犬"}]}}'
FROM bi_dashboard d
...
'{"chart":{"name":"动物综合评分","chartType":"bar","xField":"动物","yField":"综合值","groupField":""},"style":{"theme":"海湾晨光","bgColor":"rgba(0,0,0,0)","showLegend":false,"showLabel":true,"showGrid":false,"barRadius":12,"barMaxWidth":28},"interaction":{"dataFilters":[{"field":"模块","value":"综合评分"}]}}'
FROM bi_dashboard d
...
'{"chart":{"name":"月影灵猫节律","chartType":"business_trend","xField":"时段","yField":"活跃指数","groupField":""},"style":{"showTitle":true,"titleText":"月影灵猫节律","titleColor":"#fff1ce","metricValueColor":"#ffd675","bgColor":"rgba(0,0,0,0)"},"interaction":{"dataFilters":[{"field":"模块","value":"活动趋势"},{"field":"动物","value":"月影灵猫"}]}}'
FROM bi_dashboard d
