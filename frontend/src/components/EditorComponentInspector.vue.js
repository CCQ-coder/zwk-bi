...
import { buildChartSnapshot, buildComponentConfig, chartTypeLabel, COMPONENT_PRESETS, COLOR_THEMES, DEFAULT_COMPONENT_INTERACTION, DEFAULT_COMPONENT_STYLE, buildPresetChartConfig, getChartFieldLabels, getChartTypeMeta, getMissingChartFields, isBarFamilyChartType, isDecorationChartType, isStyleDecorationChartType, isStaticWidgetChartType, normalizeComponentDataFilters, normalizeComponentConfig, resolveConfiguredTableColumns, STYLE_DECORATION_STYLE_PRESETS, suggestChartFields, TABLE_LIKE_CHART_TYPES, } from '../utils/component-config';
    ...
    switch (componentKind.value) {
        ...
        case 'decoration':
            if (isStyleDecorationComponentType.value)
                return ['主题配色', '背景填充', '边框描边', '圆角/阴影', '容器高级'];
...
const pageSourceSelectorLabel = computed(() => {
    if (bindingEntryMode.value === 'PAGE_SQL' && (isSingleFieldType.value || isNumberFlipperType.value))
        return '选择数据源';
    return `${pageSourceKindLabel.value}数据源`;
});
const dataRefreshLabel = computed(() => (bindingEntryMode.value === 'PAGE_SQL' && configForm.chart.pageSourceKind === 'DATABASE'
    ? 'SQL 刷新间隔（秒）'
    : '刷新数据时间（秒）'));
...
const showDimensionFieldBinding = computed(() => (currentChartMeta.value.requiresDimension
...
const showMetricFieldBinding = computed(() => (currentChartMeta.value.requiresMetric
    || (isMetricComponentType.value && !isSingleFieldType.value)));
const showGroupFieldBinding = computed(() => (currentChartMeta.value.requiresGroup
    || currentChartMeta.value.allowsGroup
    || (isMetricComponentType.value && !isSingleFieldType.value && !isNumberFlipperType.value)));
const dimensionFieldLabel = computed(() => {
    if (isSingleFieldType.value)
        return '字段内容';
    if (isFilterComponentType.value)
        return '筛选字段';
...
const flushPendingDraft = () => {
    if (!props.component || !currentComponentChartId.value)
        return null;
...
watch(currentChartType, (chartType, previousType) => {
    if (chartType === previousType || !isStyleDecorationChartType(chartType))
        return;
...
if (!__VLS_ctx.component || !__VLS_ctx.chart) {
    ...
    if (__VLS_ctx.showDataTab) {
        ...
        if (__VLS_ctx.bindingEntryMode === 'DATASET') {
            ...
            const __VLS_225 = __VLS_asFunctionalComponent(__VLS_224, new __VLS_224({
                label: (__VLS_ctx.pageSourceSelectorLabel),
            }));
            ...
            if (__VLS_ctx.isSingleFieldType) {
        ...
        const __VLS_417 = __VLS_asFunctionalComponent(__VLS_416, new __VLS_416({
            label: (__VLS_ctx.dataRefreshLabel),
        }));
        ...
        if (__VLS_ctx.showDimensionFieldBinding && !__VLS_ctx.isSingleFieldType) {
        ...
        if (__VLS_ctx.showMetricFieldBinding) {
            ...
            var __VLS_495;
            if (__VLS_ctx.isNumberFlipperType) {
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    ...{ class: "helper-text" },
                });
            }
        ...
        if (__VLS_ctx.showGroupFieldBinding) {
    ...
    if (!__VLS_ctx.isDecorationComponentType || __VLS_ctx.isStyleDecorationComponentType) {
        const __VLS_532 = {}.ElColorPicker;
    ...
    if (__VLS_ctx.showTitleSection) {
        ...
        __VLS_asFunctionalDirective(__VLS_directives.vShow)(null, { ...__VLS_directiveBindingRestFields, value: (__VLS_ctx.openSections.has('title')) }, null, null);
        if (__VLS_ctx.configForm.style.showTitle) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                ...{ class: "ss-row" },
            });
            __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...
        if (['hyperlink', 'iframe_single', 'iframe_tabs', 'image_list', 'text_list', 'word_cloud'].includes(__VLS_ctx.currentChartType)) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                ...{ class: "ss-row" },
            });
            __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    const __VLS_946 = __VLS_945({
        label: "Schema",
        name: "schema",
    }, ...__VLS_functionalComponentArgsRest(__VLS_945));
    ...
    __VLS_951.slots.default;
    var __VLS_951;
    const __VLS_956 = {}.ElButton;
    /** @type {[typeof __VLS_components.ElButton, typeof __VLS_components.elButton, typeof __VLS_components.ElButton, typeof __VLS_components.elButton, ]} */ ;
    // @ts-ignore
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            isStyleDecorationComponentType: isStyleDecorationComponentType,
            ...
            isSingleFieldType: isSingleFieldType,
            isNumberFlipperType: isNumberFlipperType,
            ...
            pageSourceSelectorLabel: pageSourceSelectorLabel,
            dataRefreshLabel: dataRefreshLabel,
            ...
            showDimensionFieldBinding: showDimensionFieldBinding,
            showMetricFieldBinding: showMetricFieldBinding,
            showGroupFieldBinding: showGroupFieldBinding,
